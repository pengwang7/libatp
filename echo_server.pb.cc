...
void protobuf_AssignDesc_echo_5fserver_2eproto() {
  protobuf_AddDesc_echo_5fserver_2eproto();
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_echo_5fserver_2eproto);
}
...
void protobuf_ShutdownFile_echo_5fserver_2eproto() {
...
void protobuf_AddDesc_echo_5fserver_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\021echo_server.proto\022\003atp\"\036\n\013EchoRequest\022"
    "\017\n\007message\030\001 \002(\t\"\037\n\014EchoResponse\022\017\n\007mess"
    "age\030\001 \002(\t2:\n\013EchoService\022+\n\004Echo\022\020.atp.E"
    "choRequest\032\021.atp.EchoResponseB\003\200\001\001", 154);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "echo_server.proto", &protobuf_RegisterTypes);
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_echo_5fserver_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_echo_5fserver_2eproto {
  StaticDescriptorInitializer_echo_5fserver_2eproto() {
    protobuf_AddDesc_echo_5fserver_2eproto();
  }
} static_descriptor_initializer_echo_5fserver_2eproto_;
...
const EchoRequest& EchoRequest::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_echo_5fserver_2eproto();
...
void EchoService::CallMethod(const ::google::protobuf::MethodDescriptor* method,
  ...
  switch(method->index()) {
    case 0:
      Echo(controller,
             ::google::protobuf::down_cast<const ::atp::EchoRequest*>(request),
             ::google::protobuf::down_cast< ::atp::EchoResponse*>(response),
             done);
      break;
    default:
...
const ::google::protobuf::Message& EchoService::GetRequestPrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::atp::EchoRequest::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
const ::google::protobuf::Message& EchoService::GetResponsePrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::atp::EchoResponse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *reinterpret_cast< ::google::protobuf::Message*>(NULL);
  }
